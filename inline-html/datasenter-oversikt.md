...
<body>
    ...
    <div class="dc-card">
      ...
      <div class="dc-metrics">
        <div class="dc-metric">
          ...
          <strong class="dc-counter" data-js="counter">0</strong>
        </div>
      </div>
      ...
      <svg class="dc-chart" viewBox="0 0 720 220" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
        ...
        <circle data-js="marker-total" r="5" fill="var(--dc-red)" stroke="#fff" stroke-width="2"></circle>
        <g data-js="labels"></g>
        <g data-js="ylabels"></g>
      </svg>
      ...
      <details class="dc-details">
        <summary>Slik fungerer nettilknytning for datasentre</summary>
  ...
  <script>
    (() => {
      ...
      const ylabelsGroup = svg.querySelector('[data-js="ylabels"]');
      ...
      const markerTotal = svg.querySelector('[data-js="marker-total"]');
      ...
      const mkYLabel = (value) => {
        const y = padding.top + innerH - ((value / maxVal) * innerH);
        const t = document.createElementNS('http://www.w3.org/2000/svg', 'text');
        t.setAttribute('x', padding.left - 6);
        t.setAttribute('y', y + 4);
        t.setAttribute('fill', 'rgba(255,255,255,0.5)');
        t.setAttribute('font-size', '11');
        t.setAttribute('font-family', 'inherit');
        t.setAttribute('text-anchor', 'end');
        t.textContent = formatter.format(value);
        ylabelsGroup.appendChild(t);
      };

      mkYLabel(0);
      mkYLabel(Math.round(maxVal / 2));
      mkYLabel(maxVal);
      ...
      const animate = () => {
        ...
        if (prefersReducedMotion) {
          ...
          markerTotal.setAttribute('cx', last.x);
          markerTotal.setAttribute('cy', last.y);
